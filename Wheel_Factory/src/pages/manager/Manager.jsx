...
// const [viewCompletedDetails,setViewCompletedDetails]=useState();
...
//     alert("form submitted sucessufully");
//   } catch (error) {
...
// // const viewCompletedDetails = async (orderId) => {
// //   try {
// //     const response = await axios.get(`http://localhost:5041/api/Transactions/${orderId}`);
// //     setViewCompletedDetails(response.data);  
// //   } catch (error) {
...
//           onClick={() => viewOrderDetails(order.orderId)}  // Update the click handler
//         >
//           View Details
//         </button>
//       </td>
